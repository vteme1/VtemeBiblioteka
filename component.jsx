              ...
              <div className="space-y-6">
                <div className="text-center">
                  <div className="border-2 border-dashed border-purple-500/50 rounded-xl p-8 hover:border-purple-500 transition-colors">
                    ...
                    <p className="text-gray-300 text-sm mb-4">
                      Поддерживаемые форматы: EPUB, FB2, TXT, DOC, DOCX, MOBI, PDF, RTF
                    </p>
                    <button
                ...
                <div className="bg-white/5 rounded-xl p-4">
                  ...
                  <ul className="text-gray-300 text-sm space-y-1">
                    <li>• <strong>🧠 Интеллектуальное определение кодировки</strong> - поддержка UTF-8/16, Windows-1251, KOI8-R, CP866 и других</li>
                    <li>• <strong>🔍 BOM детекция</strong> - автоматическое распознавание Byte Order Mark</li>
                    ...
                    <li>• <strong>✨ Продвинутая очистка текста</strong> - удаление служебной информации, нормализация, HTML/XML</li>
                    <li>• <strong>🌍 Расширенное определение языка</strong> - поддержка 7+ языков с анализом контекста</li>
                    <li>• <strong>🎯 Детекция жанров</strong> - эвристический анализ содержимого по ключевым словам</li>
                    <li>• <strong>📦 Поддержка архивных форматов</strong> - EPUB как ZIP, DOCX структуры, сложные XML</li>
                    <li>• <strong>📚 FB2 с полной поддержкой</strong> - секции, подсекции, переводчики, серии, аннотации</li>
                    <li>• <strong>📄 Продвинутый PDF парсер</strong> - извлечение текстовых объектов, потоков, метаданных</li>
                    <li>• <strong>📝 RTF с расширенной очисткой</strong> - Unicode, команды форматирования, группы</li>
